...
class AdminController extends AbstractController
{
    ...
    #[Route("/admin_commande/{id}", name:"admin_commande")]
    public function showCommande(Commande $commande)
    {
        return $this->renderForm('admin_commande.html.twig', [
            'commande' => $commande
        ]);

    }
    #[Route("/admin_vehicule/{id}", name:"admin_vehicule")]
    public function showVehicule(Vehicule $vehicule)
    {
        return $this->renderForm('/admin_vehicule.html.twig', [
            'vehicule' => $vehicule
        ]);

    }
    #[Route("/admin_membre/{id}", name:"admin_membre")]
    public function showMembre(Membre $membre)
    {
        return $this->renderForm('/admin_membre.html.twig', [
            'membre' => $membre
        ]);
